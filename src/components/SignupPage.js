  ...
  return (
    <div className="col-span-1 flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col mt-[50px]">
        ...
        <button className="mt-16 bg-[#5E73E1] text-white font-semibold rounded-2xl py-3 w-28 mx-auto transition-all ease-in-out duration-300 hover:bg-blue-800 hover:-translate-y-3" onClick={register}>
          Sign up
        </button>
