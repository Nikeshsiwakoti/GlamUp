...
const ProfileScreen = () => {
  ...
  const updateProfile = () => {
    ...
    if (profile && fullname && email && contact && address) {
      axios.put("http://localhost:1026/user/update/" + user.id, { profile, fullname, email, contact, address }).then(res => {
        console.log(res);
                ...
                <div className="row m-l-0 m-r-0">
                  <div className="col-md-4 bg-c-lite-green user-profile">
                    <div className="card-block text-center text-white">
                      ...
                      <button className="mt-8  bg-[#5E73E1] text-white font-semibold rounded-2xl py-3 w-28 mx-auto transition-all ease-in-out duration-300 hover:bg-blue-800 hover:-translate-y-3" data-bs-toggle="modal" data-bs-target="#picture">Upload Picture</button>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="photo-input"> <input type="file" id="loadFile" onchange={imgChange} /> <button class="btn btn-sm btn-primary" onClick={updateProfileImage}> Save </button> </div>
                          </div>
                          <div class="modal-footer">
